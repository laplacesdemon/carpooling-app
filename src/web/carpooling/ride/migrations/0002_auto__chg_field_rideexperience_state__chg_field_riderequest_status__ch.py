...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'RideExperience.state'
        db.alter_column(u'ride_rideexperience', 'state', self.gf('django.db.models.fields.PositiveSmallIntegerField')())

        # Changing field 'RideRequest.status'
        db.alter_column(u'ride_riderequest', 'status', self.gf('django.db.models.fields.PositiveSmallIntegerField')())

        # Changing field 'Ride.state'
        db.alter_column(u'ride_ride', 'state', self.gf('django.db.models.fields.PositiveSmallIntegerField')())

    def backwards(self, orm):

        # Changing field 'RideExperience.state'
        db.alter_column(u'ride_rideexperience', 'state', self.gf('django.db.models.fields.CharField')(max_length=64))

        # Changing field 'RideRequest.status'
        db.alter_column(u'ride_riderequest', 'status', self.gf('django.db.models.fields.CharField')(max_length=8))

        # Changing field 'Ride.state'
        db.alter_column(u'ride_ride', 'state', self.gf('django.db.models.fields.CharField')(max_length=23))
